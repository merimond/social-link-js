...
const construct = (id, type, format = null) => {
  switch (type) {
    case AngelList.NAME:
      return AngelList.construct(id, format);
    case Bloomberg.NAME:
      return Bloomberg.construct(id, format);
    case CapitalIQ.NAME:
      return CapitalIQ.construct(id, format);
    case Crunchbase.NAME:
      return Crunchbase.construct(id, format);
    case Dealroom.NAME:
      return Dealroom.construct(id, format);
    case DealTinder.NAME:
      return DealTinder.construct(id, format);
    case Facebook.NAME:
      return Facebook.construct(id, format);
    case LinkedIn.NAME:
      return LinkedIn.construct(id, format);
    case PEI.NAME:
      return PEI.construct(id, format);
    case Sociopath.NAME:
      return Sociopath.construct(id, format);
    case Signal.NAME:
      return Signal.construct(id, format);
    case Twitter.NAME:
      return Twitter.construct(id, format);
    default:
      return null;
  }
};

export default { parse, construct };
